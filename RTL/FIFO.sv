...
reg [intf.max_fifo_addr - 1 : 0] wr_ptr;
reg [intf.max_fifo_addr - 1 : 0] rd_ptr;
reg [intf.max_fifo_addr : 0] count;
...
assign intf.almostfull = (count == fifo_if.FIFO_DEPTH - 1)? 1 : 0; 
